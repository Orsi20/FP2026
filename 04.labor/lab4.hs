import Main (myLength, pDec, ls1, listaN)
...
szamokLs n
    | n == 1 = replicate n n  -- elso parameter jeloli hanyszor, masodik hogy mit replikaljon
...
decPSzam x p = length $ decP x pDec
...
myLength2 [] = 0
myLength2 (_ : ls) = 1 + myLength2 ls1
